...
<div style="text-align:right;margin-top:30px;">
    <table align="right">
        ...
        <tr>
            <td width="200px"><p style="margin:0;color:#37474F; font-style: normal;font-size: 16px;line-height: 22px;">Commission Charges </p></td>
            <td width="20px">:</td>
        ...
        <tr>
            <td width="200px"><p style="margin:0;color:#37474F; font-style: normal;font-size: 16px;line-height: 22px;">Receivable Amount </p></td>
            <td width="20px">:</td>
